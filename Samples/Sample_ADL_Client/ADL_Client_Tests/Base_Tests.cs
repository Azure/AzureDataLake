...
namespace ADL_Client_Tests
{
    public class Base_Tests
    {
        ...
        public AzureDataLake.Analytics.AnalyticsCatalogClient adla_catalog_client;
        ...
        public void Initialize()
        {
            if (this.init == false)
            {
                ...
                this.adla_catalog_client = new AzureDataLake.Analytics.AnalyticsCatalogClient(analytics_account, auth_session);
